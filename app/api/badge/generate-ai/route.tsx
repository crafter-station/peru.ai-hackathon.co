...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!participant.profilePhotoAiUrl) {
      return NextResponse.json(
        { error: "AI avatar required for badge generation. Please complete onboarding first." },
        { status: 400 },
      );
    }
    ...
    console.log(
      "[badge-ai] Generating badge for participant",
      participant.participantNumber,
    );

    console.log("[badge-ai] STEP 1: Reusing AI avatar from onboarding");
    console.log("[badge-ai] AI avatar URL:", participant.profilePhotoAiUrl);
    ...
    console.log(
      "[badge-ai] Badge composed, uploading to Vercel Blob",
    );
