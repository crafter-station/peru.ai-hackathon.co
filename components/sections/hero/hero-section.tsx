      ...
      <div className="relative z-50 text-center px-4 md:px-8 max-w-6xl mx-auto pointer-events-none">
        ...
        >
          ...
          <div className="flex justify-center items-center mb-4">
            <a
              ...
              className="group relative transition-all duration-300 hover:opacity-80 hover:scale-105"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <ExternalLink className="w-4 h-4 text-white opacity-0 group-hover:opacity-100 transition-all duration-300 drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 2px rgba(0,0,0,0.8))' }} />
              </div>
            </a>
          </div>
        ...
        >
          <Button
            ...
            size="lg"
            onClick={() => play()}
            className="px-8 py-4 bg-red-600 text-white font-bold text-lg hover:bg-red-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
            style={{ pointerEvents: "auto" }}
          >
            <a
          ...
          <Button
            ...
            className="group px-8 py-4 text-white font-bold text-lg bg-white/10 border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-200"
            style={{ pointerEvents: "auto" }}
          >
            <div className="flex items-center gap-3">
              <svg
                ...
                className="w-4 h-4 animate-bounce transition-transform duration-300 group-hover:translate-y-1"
              >
