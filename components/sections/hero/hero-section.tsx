  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-50 text-center px-4 md:px-8 max-w-6xl mx-auto pointer-events-none">
        ...
        <div className="mb-6 md:mb-12 opacity-100 px-4">
          <div className="flex justify-center items-center">
            <Image
              ...
              width={800}
              height={200}
              className="w-full max-w-sm sm:max-w-md md:max-w-xl h-auto"
              priority
            />
          </div>
        </div>
        ...
        <div
          className={`
          max-w-lg mx-auto mb-6 md:mb-8 px-2 transition-all duration-300 transform
          ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}
        `}
          style={{ transitionDelay: "150ms" }}
        >
          <p
            className="text-base sm:text-lg md:text-xl text-white leading-relaxed mb-2 drop-shadow-lg"
            style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.8)" }}
          >
            Únete al evento de inteligencia artificial más importante del Perú
          </p>
          <p
            className="text-sm sm:text-base md:text-lg text-gray-200 drop-shadow-lg"
        ...
        <div
          className={`
          flex flex-col gap-3 sm:gap-4 justify-center items-center px-4
        ...
        >
          <Button
            ...
            size="lg"
            onClick={() => play()}
            className="w-full max-w-xs px-6 py-3 sm:px-8 sm:py-4 bg-brand-red text-white font-bold text-sm sm:text-base md:text-lg border-0 rounded-none hover:bg-brand-red/90"
            style={{ pointerEvents: "auto" }}
          >
            <a
            ...
            >
              <div className="flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 bg-white/10 rounded-sm">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
          ...
          <Button
            ...
            className="w-full max-w-xs px-6 py-3 sm:px-8 sm:py-4 text-white font-bold text-sm sm:text-base md:text-lg bg-transparent border-0 rounded-none hover:bg-white/5 transition-all duration-300 group"
            style={{ pointerEvents: "auto" }}
          >
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              <div className="flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 transition-transform duration-300 group-hover:translate-y-1">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
